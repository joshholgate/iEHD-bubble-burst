...
//#define JMAX 300 			/* number of cells in z-direction */
//#define INV_H 50.0			/* cell width */
//#define INV_RE 0.004 // for Li/W // 0.00089 // for water, U=10m/s D=100um	/* inverse Reynolds number */
//#define INV_WE 1.4 // for W // 0.007 // for Li and water		/* inverse Weber number */
//#define INV_FRSQR 0.0			/* inverse square Froude number */
//#define INV_WEE 35.0			/* inverse electrical Weber number */

#define IMAX 200			/* number of cells in r-direction */
#define JMAX 600 			/* number of cells in z-direction */
#define INV_H 50.0			/* cell width */
#define INV_RE 0.003368			/* inverse Reynolds number */
#define INV_WE 0.4295			/* inverse Weber number */
#define INV_FRSQR 0.0			/* inverse square Froude number */
#define INV_WEE 9.479			/* inverse electrical Weber number */
...
#define FINAL_TIME 5.0		/* termination time of simulation */
...
/*	// Set up LS for 'surface' problem
	...
	for (int i=0; i<=IMAX+1; i++) {
		for (int j=0; j<=JMAX+1; j++) {
			...
			LSsurface = -(Z-4.0);
			LSbubble = sqrt( (Z-3.25)*(Z-3.25)+R*R ) - 1.0;
